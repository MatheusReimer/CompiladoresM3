...
public class SemanticTable {
   ...
   static int expTable [][][] = 
     ...
     /*   INT*/ {{INT,INT,INT,FLO,INT},{FLO,FLO,FLO,FLO,BOO},{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR}},
     /* FLOAT*/ {{FLO,FLO,FLO,FLO,BOO},{FLO,FLO,FLO,FLO,BOO},{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR}},
     /*  CHAR*/ {{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{CHA,CHA,ERR,ERR,ERR},{STR,STR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR}},
     /*STRING*/ {{ERR,ERR,ERR,ERR,BOO},{ERR,ERR,ERR,ERR,BOO},{STR,STR,ERR,ERR,BOO},{STR,STR,ERR,ERR,BOO},{ERR,ERR,ERR,ERR,ERR}},
